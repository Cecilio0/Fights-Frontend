            ...
            <div className="container space-y-6 px-4 md:px-6">
                <div className="grid md:grid-cols-[250px,1fr] items-start gap-6 lg:gap-10">
                    <div className="flex flex-col items-start space-y-2">
                        ...
                        <h2 className="text-xl font-semibold">{fighter.baseClass.name.charAt(0).toUpperCase() + fighter.baseClass.name.slice(1)}</h2>
                        <Badge variant="secondary">{fighter.baseClass.mainAttribute.charAt(0).toUpperCase() + fighter.baseClass.mainAttribute.slice(1)}</Badge>
                        <Badge variant="secondary">{fighter.baseClass.secondaryAttribute.charAt(0).toUpperCase() + fighter.baseClass.secondaryAttribute.slice(1)}</Badge>
                    </div>
                                ...
                                <table className="table-auto w-full">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="border-b text-right">{fighter.strength}</td>
                                        </tr>
                                        <tr>
                                            <td className="font-bold border-b">Dexterity</td>
                                            <td className="border-b text-right">{fighter.dexterity}</td>
                                        </tr>
                                        <tr>
                                            <td className="font-bold  border-b">Constitution</td>
                                            <td className="border-b text-right">{fighter.constitution}</td>
                                        </tr>
                                        <tr>
                                            <td className="font-bold  border-b">Intelligence</td>
                                            <td className="border-b text-right">{fighter.intelligence}</td>
                                        </tr>
                                        <tr>
                            ...
                            <CardContent>
                                <Accordion type="single" collapsible className="w-full">
                                    {fighter.subplots.map((subplot: Subplot, index: number) => (
                                        <AccordionItem value={`item-${index + 1}`} key={subplot.id_subplot}>
